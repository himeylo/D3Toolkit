...
class D3Toolkit_Save
{
	...
	/**
	 * The strategy meta data for the item currently being saved.
	...
	/**
	 * Updates the strategy meta using the $_prefix object variable to set the key and the sanitized $_meta_data.
	 *
	 * @access private
	 * @return void
	 */
